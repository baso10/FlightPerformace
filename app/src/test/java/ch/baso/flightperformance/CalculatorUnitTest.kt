...
class CalculatorUnitTest {
    ...
    private fun loadBristellB23(): Airplane {
        val airplane = Airplane()
        airplane.name = "BristellB23"
        airplane.landingPerformance = Arrays.asList(
                "136,362,141,376,146,391,151,405,157,419",
                "146,389,151,405,157,420,163,436,169,451",
                "157,419,163,436,169,453,175,469,182,485",
                "169,452,175,470,182,488,189,505,196,523")
        airplane.takeOffPerformance = Arrays.asList(
                "309,400,335,438,365,479,396,523,431,570",
                "362,470,396,515,432,562,475,616,522,675",
                "431,554,476,610,526,671,584,739,652,818",
                "525,663,587,735,661,818,747,915,852,1030")
        airplane.emptyWeight = 448.0
        airplane.emptyMoment = 775.64
        return airplane
    }
    ...
    @Test
    fun bristellB23Calculator() {
        val airplane = loadBristellB23()
        val calculator = BristellB23Calculator()
        var result: TakeoffLanding

        var inputs = arrayOf(
                intArrayOf(0, 15, 365, 479),
                intArrayOf(1600, 12, 407, 530),
                intArrayOf(2500, 21, 479, 619),
                intArrayOf(9999, -100, 525, 663),
                intArrayOf(-9999, 100, 431, 570)
        )
        for (i in inputs.indices) {
            val input = inputs[i]
            result = calculator.calculate(InputData(airplane, ArrayList(), input[1], input[0])).takeoff
        ...
        /////
        inputs = arrayOf(
                intArrayOf(0, 15, 146, 391),
                intArrayOf(1600, 12, 152, 409),
                intArrayOf(2500, 21, 163, 437),
                intArrayOf(9999, -100, 169, 452),
                intArrayOf(-9999, 100, 157, 419)
        )
        for (i in inputs.indices) {
            val input = inputs[i]
            result = calculator.calculate(InputData(airplane, ArrayList(), input[1], input[0])).landing
